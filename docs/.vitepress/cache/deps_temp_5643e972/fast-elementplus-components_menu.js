import {
  ...
  toDisplayString,
  withCtx
} from "./chunk-VP6O7WQ6.js";

// node_modules/.pnpm/fast-elementplus-components@1.0.0/node_modules/fast-elementplus-components/menu/index.mjs
var V = defineComponent({
  ...
  setup(a) {
    return (_, r) => {
      const v = resolveComponent("el-menu-item"), o = resolveComponent("el-sub-menu"), d = resolveComponent("el-menu");
      return openBlock(), createBlock(d, mergeProps({
        ...
        default: withCtx(() => [
          (openBlock(true), createElementBlock(
            Fragment,
            null,
            renderList(a.data, (p, M) => (openBlock(), createElementBlock(
              Fragment,
              { key: M },
              [
                !p[a.children] || !p[a.children].length ? (openBlock(), createBlock(v, {
                  key: 0,
                  index: p[a.index]
                }, {
                  default: withCtx(() => [
                    p[a.icon] ? (openBlock(), createBlock(resolveDynamicComponent(`${p[a.icon]}`), { key: 0 })) : createCommentVNode("v-if", true),
                    createBaseVNode(
                      "span",
                      null,
                      toDisplayString(p[a.name]),
                      1
                      /* TEXT */
                    )
                  ]),
                ...
                p[a.children] && p[a.children].length ? (openBlock(), createBlock(o, {
                  key: 1,
                  index: p[a.index]
                }, {
                  title: withCtx(() => [
                    p[a.icon] ? (openBlock(), createBlock(resolveDynamicComponent(`${p[a.icon]}`), {
                      key: 0,
                      '"': ""
                  ...
                  default: withCtx(() => [
                    (openBlock(true), createElementBlock(
                      Fragment,
                      null,
                      renderList(p[a.children], (w, C) => (openBlock(), createBlock(v, {
                        key: C,
                        index: w.index
                      }, {
                        default: withCtx(() => [
                          w[a.icon] ? (openBlock(), createBlock(resolveDynamicComponent(`${p[a.icon]}`), { key: 0 })) : createCommentVNode("v-if", true),
                          createBaseVNode(
                            "span",
                            null,
                            toDisplayString(w[a.name]),
                            1
                            /* TEXT */
                          )
                        ]),
...
var B = y(V, [["__scopeId", "data-v-650d1810"]]);
var L = defineComponent({
  name: "AddLocation",
  __name: "add-location",
  setup(a) {
    return (_, r) => (openBlock(), createElementBlock("svg", {
...
var M_ = defineComponent({
  ...
  setup(a) {
    const _ = (v) => v.map((o) => {
      o.i = x_[o[a.icon]];
      const d = {
        title: () => createVNode(Fragment, null, [createVNode(o.i, null, null), createVNode("span", null, [o[a.name]])])
      };
      return o[a.children] && o[a.children].length ? createVNode(resolveComponent("el-sub-menu"), {
        index: o[a.index]
      }, {
        ...
        default: () => [createVNode(o.i, null, null), createVNode("span", null, [o[a.name]])]
      });
    }), r = useAttrs();
    return () => {
      let v;
...
fast-elementplus-components/menu/index.mjs:
  (*! Element Plus Icons Vue v2.3.1 *)
*/
//# sourceMappingURL=fast-elementplus-components_menu.js.map
